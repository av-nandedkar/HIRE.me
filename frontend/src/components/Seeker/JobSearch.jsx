  ...
  <motion.div 
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm sm:text-base">
        ...
        <p className="text-gray-700"><strong>Experience:</strong> {selectedJob.experienceLevel}</p>
        ...
        <p className="text-gray-700"><strong>City:</strong> {selectedJob.city}, {selectedJob.state}</p>
        <p className="text-gray-700"><strong>Street:</strong> {selectedJob.street}</p>
        <p className="text-gray-700"><strong>Locality:</strong> {selectedJob.locality}</p>
        <p className="text-gray-700"><strong>Pincode:</strong> {selectedJob.pincode}</p>
